...
from pig_track.deep.feature_extractor import Extractor
from pig_track.sort.nn_matching import NearestNeighborDistanceMetric
from pig_track.sort.preprocessing import non_max_suppression
from pig_track.sort.detection import Detection
from pig_track.sort.tracker import Tracker
...
class DeepSort(object):
    def __init__(self, model_path, max_dist=0.2, \
        ...
        #----added by deyiwang
        namesfile = 'F:\\pig_healthy\\code\\pig_detect\\YOLOV4\\model_data\\voc_classes.txt'
